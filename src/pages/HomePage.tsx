...
import { getLeaderboard, getNenecoinBalance, getGiftMessages, settleExpiredQuestions } from "@/lib/supabase/queries";
...
export default function Home() {
  ...
  useEffect(() => {
    if (!profile) return;
    // Liquida as perguntas vencidas antes de ler o ranking, senão os pontos do
    // settle só apareceriam no próximo load.
    settleExpiredQuestions().then(() => getLeaderboard().then(setLeaderboard));
